...
%             real_data(i,end) = 3;   % Low accuracy, Previous Incorrect
%             real_data(i,end) = 5;   % High accuracy, Previous Incorrect
%         elseif real_data(i,4)=='high' && real_data(i,12) == '0'
%             real_data(i,end) = 6;   % High accuracy, Previous Correct
%         end 
%     end
...
%             real_data(i,end) = 4;   % Low accuracy, Previous Correct
%         elseif real_data(i,4)=='high' && real_data(i,12) == '1'
        ...
        elseif real_data(i,4)=='low' && real_data(i,12) == '1' && real_data(i,3) == 'easy'
            real_data(i,end) = 5;   % Low accuracy, Easy, Previous Incorrect
        elseif real_data(i,4)=='low' && real_data(i,12) == '1' && real_data(i,3) == 'hard'
            real_data(i,end) = 6;   % Low accuracy, Hard, Previous Incorrect
        elseif real_data(i,4)=='low' && real_data(i,12) == '0' && real_data(i,3) == 'easy'
            real_data(i,end) = 7;   % Low accuracy, Easy, Previous Correct
        elseif real_data(i,4)=='low' && real_data(i,12) == '0' && real_data(i,3) == 'hard'
            real_data(i,end) = 8;   % Low accuracy, Hard, Previous Correct
        elseif real_data(i,4)=='high' && real_data(i,12) == '1' && real_data(i,3) == 'easy'
            real_data(i,end) = 9;   % High accuracy, Easy, Previous Incorrect
        elseif real_data(i,4)=='high' && real_data(i,12) == '1' && real_data(i,3) == 'hard'
            real_data(i,end) = 10;   % High accuracy, Hard, Previous Incorrect
        elseif real_data(i,4)=='high' && real_data(i,12) == '0' && real_data(i,3) == 'easy'
            real_data(i,end) = 11;   % High accuracy, Easy, Previous Correct
        elseif real_data(i,4)=='high' && real_data(i,12) == '0' && real_data(i,3) == 'hard'
            real_data(i,end) = 12;   % High accuracy, Hard, Previous Correct
        end 
    end
...
%     model(2).v = 6; model(2).A = 1; model(2).b = 1; model(2).t0 = 1; model(2).sv = 1;
%     model(3).v = 1; model(3).A = 1; model(3).b = 6; model(3).t0 = 1; model(3).sv = 1;
%     model(4).v = 6; model(4).A = 1; model(4).b = 6; model(4).t0 = 1; model(4).sv = 1; 
...
for i = 1:maxidnum
    if i == 14 || i == 24 || i == 20 || i == 49 || i == 51 || i == 53 % have overall accuracy < 70% (determined in R)
        m4_opt_LL(i,:) = repelem(NaN,4);
    else
        m4_opt_LL(i,:) = ind_opt_LL{1,i};
    end
end
